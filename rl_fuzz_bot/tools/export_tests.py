# rl_fuzz_bot/tools/export_tests.py
...
def export_tests(input_file: str, output_dir: str):
    # Load the JSON of failure records (must include "seed" and "episode")
    with open(input_file, "r") as f:
        failures = json.load(f)

    # Prepare output dir and __init__.py
    ...
    # Write one pytest file per failure
